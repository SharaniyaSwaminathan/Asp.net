...
namespace Shopping_Cart
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void btnAddMobiletoCart_Click(object sender, EventArgs e)
        {
            ...
            {
                mobileBill += (Convert.ToUInt64(drpSamsungMobile.SelectedValue) * 60000);
            }
            if (drpBlackberryMobile.SelectedValue != "0")
            {
                mobileBill += (Convert.ToUInt64(drpBlackberryMobile.SelectedValue) * 1200);
            }
            if (drpIphone.SelectedValue != "0")                                       
            {
                mobileBill += (Convert.ToUInt64(drpIphone.SelectedValue) * 2000);
            }
